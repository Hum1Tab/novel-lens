...
export class ProjectStore {
  ...
  async resetSetting(key: "writingMode" | "theme" | "font" | "fontSize" | "lineHeight" | "width"): Promise<void> { const m = await load(this.root); delete m.settings[key]; await saveManifest(this.root, m); }
